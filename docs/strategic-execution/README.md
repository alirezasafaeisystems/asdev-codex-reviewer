# Strategic Execution - asdev-codex-reviewer

This folder operationalizes ASDEV Strategic Execution Blueprint v1.0.0 for this repository.

## Structure
- blueprint-v1.0.0/: versioned blueprint snapshot
